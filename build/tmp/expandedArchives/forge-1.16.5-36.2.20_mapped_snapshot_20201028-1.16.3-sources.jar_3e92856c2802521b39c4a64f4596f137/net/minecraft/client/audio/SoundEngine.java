...
public class SoundEngine {
   ...
   public final Listener listener = this.sndSystem.getListener();
   ...
   private int ticks;
   public final Map<ISound, ChannelManager.Entry> playingSoundsChannel = Maps.newHashMap();
   ...
   public final Map<ISound, Integer> delayedSounds = Maps.newHashMap();
