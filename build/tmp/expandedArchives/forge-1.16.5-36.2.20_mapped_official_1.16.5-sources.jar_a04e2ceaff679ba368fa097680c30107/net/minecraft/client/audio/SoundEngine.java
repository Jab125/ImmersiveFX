...
public class SoundEngine {
   ...
   public final Listener listener = this.library.getListener();
   ...
   public final Map<ISound, ChannelManager.Entry> instanceToChannel = Maps.newHashMap();
   ...
   public final Map<ISound, Integer> queuedSounds = Maps.newHashMap();
